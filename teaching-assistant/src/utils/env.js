...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_PERSONA_FRENCH_FRIENDLY: process.env.NEXT_PUBLIC_PERSONA_FRENCH_FRIENDLY,
    NEXT_PUBLIC_PERSONA_FRENCH_PROFESSIONAL: process.env.NEXT_PUBLIC_PERSONA_FRENCH_PROFESSIONAL,
    NEXT_PUBLIC_PERSONA_FRENCH_FORMAL: process.env.NEXT_PUBLIC_PERSONA_FRENCH_FORMAL,
    NEXT_PUBLIC_PERSONA_SPANISH_FRIENDLY: process.env.NEXT_PUBLIC_PERSONA_SPANISH_FRIENDLY,
    NEXT_PUBLIC_PERSONA_SPANISH_PROFESSIONAL: process.env.NEXT_PUBLIC_PERSONA_SPANISH_PROFESSIONAL,
    NEXT_PUBLIC_PERSONA_SPANISH_FORMAL: process.env.NEXT_PUBLIC_PERSONA_SPANISH_FORMAL,
    NEXT_PUBLIC_PERSONA_GERMAN_FRIENDLY: process.env.NEXT_PUBLIC_PERSONA_GERMAN_FRIENDLY,
    NEXT_PUBLIC_PERSONA_GERMAN_PROFESSIONAL: process.env.NEXT_PUBLIC_PERSONA_GERMAN_PROFESSIONAL,
    NEXT_PUBLIC_PERSONA_GERMAN_FORMAL: process.env.NEXT_PUBLIC_PERSONA_GERMAN_FORMAL,
    NEXT_PUBLIC_BASE_URL: process.env.NEXT_PUBLIC_BASE_URL,
    NEXT_PUBLIC_DISABLE_BRAINS: process.env.NEXT_PUBLIC_DISABLE_BRAINS === "true",
    NEXT_PUBLIC_DISABLE_FILLER_PHRASES: process.env.NEXT_PUBLIC_DISABLE_FILLER_PHRASES === "true",
  },
