...
async function getSessionToken(interviewSetup) {
  try {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (startInterviewButton) {
    startInterviewButton.addEventListener("click", async (e) => {
      ...
      try {
        ...
        const sessionToken = await getSessionToken(interviewSetupText);
  ...
  if (endInterviewButton) {
    endInterviewButton.addEventListener("click", async () => {
      ...
      const feedbackLoadingSpinner = document.getElementById(
      ...
      try {
        const systemPrompt =
          "The user has just completed being interviewed by the AI interviewer and would like feedback. Please provide feedback " +
        ...
        const parsedMessageHistory = messageHistory
        ...
        feedbackText.innerHTML = DOMPurify.sanitize(
