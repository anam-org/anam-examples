...
const CoreApiRestClient_1 = require("./modules/CoreApiRestClient");
const StreamingClient_1 = require("./modules/StreamingClient");
class AnamClient {
    ...
    startSession(userProvidedAudioStream) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.streamingClient = new StreamingClient_1.StreamingClient(sessionId, {
                    engine: {
