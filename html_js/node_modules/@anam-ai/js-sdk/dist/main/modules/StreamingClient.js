...
const signalling_1 = require("../types/signalling");
const EngineApiRestClient_1 = require("./EngineApiRestClient");
const SignallingClient_1 = require("./SignallingClient");
class StreamingClient {
    constructor(sessionId, options) {
        ...
        this.signallingClient = new SignallingClient_1.SignallingClient(sessionId, options.signalling, this.onSignalMessage.bind(this), this.onSignallingClientConnected.bind(this), this.onSignallingClientFailed.bind(this));
        // initialize engine API client
        this.engineApiRestClient = new EngineApiRestClient_1.EngineApiRestClient(options.engine.baseUrl, sessionId);
    }
    ...
    onSignalMessage(signalMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (signalMessage.actionType) {
                case signalling_1.SignalMessageAction.ANSWER:
                    ...
                    break;
                case signalling_1.SignalMessageAction.ICE_CANDIDATE:
                    ...
                    break;
                case signalling_1.SignalMessageAction.END_SESSION:
                    ...
                    this.shutdown();
                    break;
                case signalling_1.SignalMessageAction.WARNING:
    ...
    onSignallingClientFailed() {
        ...
        if (this.onConnectionClosedCallback) {
            this.onConnectionClosedCallback(constants_1.PUBLIC_MESSAGE_ON_SIGNALLING_CLIENT_CONNECTION_FAILURE);
        }
    }
    ...
    handleWebrtcFailure(err) {
        ...
        if (this.onConnectionClosedCallback) {
            this.onConnectionClosedCallback(constants_1.PUBLIC_MESSAGE_ON_WEBRTC_FAILURE);
        }
    }
